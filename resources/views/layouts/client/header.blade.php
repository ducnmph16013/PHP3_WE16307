            ...
            <div class="row align-self-center">
                ...
                <div class="col-auto align-self-center">
                    <div class="header-logo">
                        <a href="index.html"><img src="/assets/client/images/logo/logo.png" alt="Site Logo" /></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <div class="header-bottom-set dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a class="dropdown-item" href="/admin/product">My account</a></li>
                                ...
                                <ul class="mega-menu d-block">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu-banner w-100">
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="/assets/client/images/banner/3.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img class="img-responsive w-100" src="/assets/client/images/banner/4.jpg" alt=""></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
    ...
    <div class="inner">
        ...
        <div class="body customScroll">
            <ul class="minicart-product-list">
                <li>
                    <a href="single-product.html" class="image"><img src="/assets/client/images/product-image/1.jpg" alt="Cart product Image"></a>
                    <div class="content">
                ...
                <li>
                    <a href="single-product.html" class="image"><img src="/assets/client/images/product-image/2.jpg" alt="Cart product Image"></a>
                    <div class="content">
                ...
                <li>
                    <a href="single-product.html" class="image"><img src="/assets/client/images/product-image/3.jpg" alt="Cart product Image"></a>
                    <div class="content">
